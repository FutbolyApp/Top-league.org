...
echo "🔧 Fixing WebSocket initialization error..."
...
initializeDatabase().then(() => {
  ...
  // FIXED: Initialize WebSocket after database - handle as non-Promise
  try {
    initializeWebSocket();
...
# Test the endpoints
echo "🧪 Testing endpoints after WebSocket fix..."
sleep 10
...
echo "🎉 WebSocket error fix completed!"
